...
#     # puts "#{n.to_s.lenght}" #nil
#     n.to_s.lenght.to_s
# end

# puts "_".center(20,"_")
# puts numeros.lenght
# puts resultado.lenght
# puts resultado
...
# Obtener un arreglo resultante de la búsqueda de 
# todos los números que comiencen o terminen por 7.

resultado = numeros.select { |n|
    n.to_s.start_wit? "7" or n.to_s.end_with? "7"
}
